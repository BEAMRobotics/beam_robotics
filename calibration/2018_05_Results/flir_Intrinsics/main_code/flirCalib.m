...
% Input Information:
    ...
    imDir = '/home/evan/research/calibration/flir_complement/';
    imType = '*.jpg';
    userName = 'Evan McLaughlin';
...
% Print to text file
fid = fopen(fullfile([captureDate, '_flir_calibration','.txt']), 'wt');
fprintf(fid, 'Flir Calibration Results:\n');
fprintf(fid, '--------------------------\n');
