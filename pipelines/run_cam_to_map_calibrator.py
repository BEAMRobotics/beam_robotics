...
logger = logging.getLogger("RUN_CAM_TO_MAP_CALIBRATOR")
BIN_PATH = "/userhome/catkin_ws/build/camera_to_map_calibrator/camera_to_map_calibrator_main"
DATA_PATH = "/userhome/data"
IMAGES_LIST_FILENAME = "selected_images.json"
MAP_FILENAME = "map.pcd"
POSES_FILENAME = "final_poses.json"
OUTPUT_FILENAME = "new_extrinsics.json"
