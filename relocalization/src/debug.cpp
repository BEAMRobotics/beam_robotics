...
int main() {
  ...
  //     cv::Mat match_descriptor = desc->ExtractDescriptors(match,
  //     match_keypoint); std::vector<cv::DMatch> matches =
  //     mat->MatchDescriptors(
