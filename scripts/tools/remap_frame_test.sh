...
# Test cases for path coverage of 'remap_frame.py'
# The following shell script iteratively calls 'remap_frame.py' with different raw input arguments to check for bugs on all paths
